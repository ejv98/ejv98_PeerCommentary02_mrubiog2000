---
title: "ejv98_PeerCommentary02_mrubiog2000"
...
#Liz: I set mine up the same way! Works well. Although, I noticed Diego has a very efficient way of doing it, as you guys mentioned before. 
...
```
#Diego: Perfect!
#Liz: Nice! I set mine up the same. 
...
```
#Diego: Perfect!
#Liz: Nice! I did the same thing as well
...
#Liz: I set mine up with dpois as Diego suggested, but I see you both commented on my own code that this is a more efficient way of doing it. 
...
#Liz: The code runs well! I had my own issues with this question, but I see how you broke it up. Its nice to see your thought process. I am going to give this a try! 
